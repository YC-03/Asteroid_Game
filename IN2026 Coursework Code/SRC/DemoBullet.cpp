...
DemoBullet::DemoBullet(GLVector3f p, GLVector3f v, GLVector3f a, GLfloat h, GLfloat r, int ttl)
	: GameObject("DemoBullet", p, v, a, h, r), mTimeToLive(ttl)
{
}

/** Copy constructor. */
DemoBullet::DemoBullet(const DemoBullet& b)
	: GameObject(b),
